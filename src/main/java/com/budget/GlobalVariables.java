...
/**
 * Global variables and constants accessible throughout the application. This
 * class provides centralized control over application-wide settings including
 * logging.
 */
public final class GlobalVariables {
    ...
    /**
     * Change the logging level for the entire application This method attempts
     * to set the logging level using reflection to avoid direct dependencies
     * 
    ...
    public static void setLoggingLevel(String level) {
        ...
        try {
            ...
            if (rootLogger.getClass().getName().contains("logback")) {
                ...
                debugMode = "DEBUG".equals(logLevel) || "TRACE".equals(logLevel);
                System.out.println(
                        "Logging level state updated to: " + logLevel + " (runtime change may not be supported)");
            }
            ...
            debugMode = "DEBUG".equals(logLevel) || "TRACE".equals(logLevel);
            System.out.println(
                    "Logging level state updated to: " + logLevel + " (runtime change failed: " + e.getMessage() + ")");
        }
    }
