...
public static final String RUNNING_TOTAL_INSERT = 
...
public static final String RUNNING_TOTAL_UPDATE = 
    "UPDATE category_running_totals SET " +
...
public static final String RUNNING_TOTAL_GET_PREVIOUS = 
    "SELECT running_total FROM category_running_totals " +
    "WHERE category_id = ? AND month_date = ? ORDER BY updated_date DESC LIMIT 1";

public static final String RUNNING_TOTAL_GET_ALL_FOR_MONTH = 
...
public static final String RUNNING_TOTAL_GET_NEGATIVE_TOTALS = 
    "SELECT rt.*, c.category FROM category_running_totals rt " +
    "JOIN categories c ON rt.category_id = c.id " +
