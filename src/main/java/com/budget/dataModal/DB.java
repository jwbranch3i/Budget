...
public final class DB {
    ...
    public static final String ACTUAL_FIND_CATEGORY = buildSelectQuery(
            new String[] { ACTUAL_COL_ID, ACTUAL_COL_CATEGORY, ACTUAL_COL_DATE, ACTUAL_COL_ACTUAL }, ACTUAL_TABLE,
            ACTUAL_COL_CATEGORY + " = ? AND " + buildDateFilter(ACTUAL_COL_DATE, "month") + " = ? AND "
    ...
    /**
     * Update actual record with all fields. Parameters: date, actual, budget,
     * startBal, id
     */
     ...
     */
    public static final String ACTUAL_GET_YEARS = "SELECT DISTINCT " + buildDateFilter(ACTUAL_COL_DATE, "year")
    ...
    public static final String ACTUAL_GET_LINE_ITEMS_FOR_MONTH = "SELECT " + ACTUAL_TABLE + "." + ACTUAL_COL_ID + ", "
            + ACTUAL_TABLE + "." + ACTUAL_COL_BUDGET + ", " + ACTUAL_TABLE + "." + ACTUAL_COL_ACTUAL + ", " + CAT_TABLE
            + "." + CAT_COL_DEFAULT_MAXIMUM_AMOUNT + ", " + CAT_TABLE + "." + CAT_COL_CATEGORY + " FROM " + ACTUAL_TABLE
            + " JOIN " + CAT_TABLE + " ON " + ACTUAL_TABLE + "." + ACTUAL_COL_CATEGORY + " = " + CAT_TABLE + "."
            + CAT_COL_ID + " WHERE " + ACTUAL_TABLE + "." + ACTUAL_COL_DATE + " LIKE ? || '%'";

    // ========================= COMPLEX QUERIES =========================

    /**
     * Get actual and budget amounts with category details. Parameters: month,
     * year, type
     */
    ...
    public static final String FIND_MISSING_CATEGORIES = "SELECT "
            ...
            + " WHERE " + CAT_COL_ID + " NOT IN (" + "SELECT " + ACTUAL_COL_CATEGORY + " FROM " + ACTUAL_TABLE
    ...
    public static final String UPDATE_TO_LAST_MONTH_BUDGET = "UPDATE " + ACTUAL_TABLE + " SET " + ACTUAL_COL_BUDGET
            ...
            + ACTUAL_COL_CATEGORY + " = " + ACTUAL_TABLE + "." + ACTUAL_COL_CATEGORY + " AND "
    ...
    public static final String UPDATE_BALANCE = "UPDATE " + ACTUAL_TABLE + " SET " + ACTUAL_COL_STARTBAL
            ...
            + " AS a " + "WHERE a." + ACTUAL_COL_CATEGORY + " = " + ACTUAL_TABLE + "." + ACTUAL_COL_CATEGORY + " AND "
            + buildYearMonthFilter("a." + ACTUAL_COL_DATE) + " = ?), 0) " + "WHERE "
            + buildYearMonthFilter(ACTUAL_COL_DATE) + " = ?";
    ...
    private static String buildComplexSelectQuery() {
        ...
        String[] selectColumns = { ACTUAL_TABLE + "." + ACTUAL_COL_ID + " AS ID",
                ...
                CAT_TABLE + "." + CAT_COL_PARENT + " AS PARENT", CAT_TABLE + "." + CAT_COL_CATEGORY + " AS CATEGORY",
        ...
        query.append(" FROM ").append(CAT_TABLE).append(" INNER JOIN ").append(ACTUAL_TABLE).append(" ON ")
                .append(ACTUAL_TABLE).append(".").append(ACTUAL_COL_CATEGORY).append(" = ").append(CAT_TABLE)
                .append(".").append(CAT_COL_ID);

        // WHERE clause - Changed to use YYYY-MM format
        query.append(" WHERE ").append(buildYearMonthFilter(ACTUAL_TABLE + "." + ACTUAL_COL_DATE)).append(" = ? AND ")
                .append(CAT_TABLE).append(".").append(CAT_COL_TYPE).append(" = ?");

        // ORDER BY clause
        query.append(" ORDER BY ").append(CAT_TABLE).append(".").append(CAT_COL_PARENT).append(", ").append(CAT_TABLE)
                .append(".").append(CAT_COL_MAIN_CATEGORY).append(" DESC");
