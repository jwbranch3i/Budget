...
public class DB {
    ...
    /*
     * SELECT category.category AS CATEGORY, actual.date AS DATE, actual.amount
     * AS ACTUAL, budget.amount AS BUDGET FROM category INNER JOIN actual ON
    ...
    public static final String GET_ACTUAL = "SELECT " + CAT_TABLE + "." + CAT_COL_CATEGORY + " AS CATEGORY, "
            ...
            + " AS ACTUAL, " + BUDGET_TABLE + "." + BUDGET_COL_AMOUNT + " AS BUDGET FROM " + CAT_TABLE + " INNER JOIN "
            + ACTUAL_TABLE + " ON " + ACTUAL_TABLE + "." + ACTUAL_COL_CATEGORY + " = " + CAT_TABLE + "." + CAT_COL_ID
            + " INNER JOIN " + BUDGET_TABLE + " ON " + BUDGET_TABLE + "." + BUDGET_COL_CATEGORY + " = " + CAT_TABLE
     ...
     * INNER JOIN actual ON actual.category = category.id WHERE STRFTIME('%m',
     * actual.date) = ? AND STRFTIME('%Y', actual.date) = ? AND category.type =
     * ?"
     */
    public static final String GET_ACTUAL_AND_BUDGET_AMOUNTS = "SELECT " + ACTUAL_TABLE + "." + ACTUAL_COL_ID
            + " AS ID, " + CAT_TABLE + "." + CAT_COL_CATEGORY + " AS CATEGORY, " + ACTUAL_TABLE + "." + ACTUAL_COL_DATE
            + " AS DATE, " + ACTUAL_TABLE + "." + ACTUAL_COL_ACTUAL + " AS ACTUAL, " + ACTUAL_TABLE + "."
            + ACTUAL_COL_BUDGET + " AS BUDGET FROM " + CAT_TABLE + " INNER JOIN " + ACTUAL_TABLE + " ON " + ACTUAL_TABLE
            + "." + ACTUAL_COL_CATEGORY + " = " + CAT_TABLE + "." + CAT_COL_ID + " WHERE STRFTIME('%m', " + ACTUAL_TABLE
            + "." + ACTUAL_COL_DATE + ") = ? AND STRFTIME('%Y', " + ACTUAL_TABLE + "." + ACTUAL_COL_DATE + ") = ? AND "
            + CAT_TABLE + "." + CAT_COL_TYPE + " = ?";
