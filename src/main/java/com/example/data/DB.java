...
public class DB {
  ...
  public static final String ACTUAL_INSERT_RECORD = "INSERT INTO " + ACTUAL_TABLE + " (" + ACTUAL_COL_CATEGORY + ", "
      + ACTUAL_COL_DATE + ", " + ACTUAL_COL_ACTUAL + ", " + ACTUAL_COL_BUDGET + ") VALUES(?, ?, ?, ?)";
  ...
  /*
   * SELECT category.category AS CATEGORY, actual.date AS DATE, actual.amount AS
   * ACTUAL, budget.amount AS BUDGET FROM category INNER JOIN actual ON
   * actual.category = category.id INNER JOIN budget ON budget.category =
  ...
  public static final String GET_ACTUAL = "SELECT " + CAT_TABLE + "." + CAT_COL_CATEGORY + " AS CATEGORY, "
      ...
      + BUDGET_TABLE + "." + BUDGET_COL_AMOUNT + " AS BUDGET FROM " + CAT_TABLE + " INNER JOIN " + ACTUAL_TABLE + " ON "
      + ACTUAL_TABLE + "." + ACTUAL_COL_CATEGORY + " = " + CAT_TABLE + "." + CAT_COL_ID + " INNER JOIN " + BUDGET_TABLE
   ...
   * actual.amount AS ACTUAL, actual.budget AS BUDGET FROM category INNER JOIN
   * actual ON actual.category = category.id WHERE STRFTIME('%m', actual.date) =
  ...
  public static final String GET_ACTUAL_AND_BUDGET_AMOUNTS = "SELECT " + ACTUAL_TABLE + "." + ACTUAL_COL_ID + " AS ID, "
      + CAT_TABLE + "." + CAT_COL_CATEGORY + " AS CATEGORY, " + ACTUAL_TABLE + "." + ACTUAL_COL_DATE + " AS DATE, "
      + ACTUAL_TABLE + "." + ACTUAL_COL_ACTUAL + " AS ACTUAL, " + ACTUAL_TABLE + "." + ACTUAL_COL_BUDGET
